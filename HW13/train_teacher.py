...
test_model = f'resnet50_2_0.001_test.ckpt'
TTA_count = 5
...
if do_train:
    ...
    model = torch.hub.load('pytorch/vision:v0.10.0', model_name, weights=None, num_classes=11)
    model.to(device)
    ...
    train_set = FoodDataset("Food-11/training", train_tfm=train_tfm, files=train_files)
    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=num_workers, pin_memory=True)
    valid_set = FoodDataset("Food-11/validation", train_tfm=train_tfm, test_tfm=test_tfm, files=valid_files, TTA_count=TTA_count)
...
if do_test:
    ...
    # The argument "loader" tells how torchvision reads the data.
    test_set = FoodDataset("Food-11/evaluation", train_tfm=train_tfm, test_tfm=test_tfm, files=None, TTA_count=5)
    test_loader = DataLoader(test_set, batch_size=batch_size, shuffle=False, num_workers=num_workers, pin_memory=True)

    """# Testing and generate prediction CSV"""
    print(f'Load model {test_model}')

    model_best = torch.hub.load('pytorch/vision:v0.10.0', model_name, weights=None, num_classes=11)
